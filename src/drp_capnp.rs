...
pub mod message {
  ...
  impl <'a,> Reader<'a,>
  {
    ...
    #[inline]
    pub fn get_source(self) -> Result<text::Reader<'a>> {
    ...
    #[inline]
    pub fn get_dest(self) -> Result<text::Reader<'a>> {
    ...
    #[inline]
    pub fn get_body(self) -> Result<text::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn get_source(self) -> Result<text::Builder<'a>> {
      self.builder.get_pointer_field(0).get_text(::std::ptr::null(), 0)
    }
    #[inline]
    pub fn set_source(&mut self, value : text::Reader)  {
      self.builder.get_pointer_field(0).set_text(value);
    }
    #[inline]
    pub fn init_source(self, size : u32) -> text::Builder<'a> {
    ...
    #[inline]
    pub fn get_dest(self) -> Result<text::Builder<'a>> {
      self.builder.get_pointer_field(1).get_text(::std::ptr::null(), 0)
    }
    #[inline]
    pub fn set_dest(&mut self, value : text::Reader)  {
      self.builder.get_pointer_field(1).set_text(value);
    }
    #[inline]
    pub fn init_dest(self, size : u32) -> text::Builder<'a> {
    ...
    #[inline]
    pub fn get_body(self) -> Result<text::Builder<'a>> {
      self.builder.get_pointer_field(2).get_text(::std::ptr::null(), 0)
    }
    #[inline]
    pub fn set_body(&mut self, value : text::Reader)  {
      self.builder.get_pointer_field(2).set_text(value);
    }
    #[inline]
    pub fn init_body(self, size : u32) -> text::Builder<'a> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xcf67f172c41575f9;
  }
}
